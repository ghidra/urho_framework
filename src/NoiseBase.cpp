...
NoiseBase::NoiseBase(Context* context) :
	Object(context),
    period(256)
{
	unsigned permutation[512] = 
	{
		...
		138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180,//loop around
		151,160,137,91,90,15, 
		131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23, 
		190,6,148,247,120,234,75,0,26,197,62,94,252,219,203,117,35,11,32,57,177,33, 
		88,237,149,56,87,174,20,125,136,171,168,68,175,74,165,71,134,139,48,27,166, 
	...
	_F2 = 0.5 * (sqrtf(3.0) - 1.0);
	_G2 = (3.0 - sqrtf(3.0)) / 6.0;
	_F3 = 1.0 / 3.0;
	_G3 = 1.0 / 6.0;
}
...
void NoiseBase::Init(const unsigned p)
{
